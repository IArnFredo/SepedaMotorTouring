  ...
  <body>
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            @endif
              <form class="" action="/update/{{$data->id}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      <label for="formGroupExampleInput" class="form-label">Merk Motor</label>
                      <input type="text" class="form-control" value="{{$data->merk_motor}}" name="merk" placeholder="Tipe Motor" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" value="{{$data->tipe_motor}}" name="tipemotor" placeholder="Tipe Motor" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="number" value="{{$data->range_harga}}" name="rangeharga" min="1" max="5" class="form-control mt-3" id="formGroupExampleInput" placeholder="Range Harga" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="text" name="harga" value="{{$data->harga}}" class="form-control" id="formGroupExampleInput" placeholder="Harga" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <select class="form-select" name="tipeban" aria-label="Default select example" required>
                        <option value="{{$banpilih->id}}">{{$banpilih->tipe_ban}}</option>
                        @foreach ($ban as $ban)
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="text" value="{{$data->kapasitas_bensin}}" name="kapasitasbensin" class="form-control" id="formGroupExampleInput" placeholder="Kapasitas Bensin" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="number" value="{{$data->keiritan_bensin}}" class="form-control mt-3" name="iritbensin" id="formGroupExampleInput" placeholder="Irit Bensin" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="text" value="{{$data->pemakaian_bensin}}" class="form-control mt-3" name="pemakaianbensin" id="formGroupExampleInput" placeholder="pemakaianbensin" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="number" value="{{$data->ergonomis}}" min="1" max="5" name="ergonomis" class="form-control" id="formGroupExampleInput" placeholder="Ergonomis" required>
                      <small class="form-text text-muted">Skala : 1-5</small><br>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="number" value="{{$data->mesin}}" name="mesin" min="0" max="100" class="form-control mt-3" id="formGroupExampleInput" placeholder="Mesin" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="text" value="{{$data->mesin_cc}}" name="ccmesin" class="form-control mt-3" id="formGroupExampleInput" placeholder="CC Mesin" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="number" value="{{$data->suku_cadang}}"  min="1" max="5" name="sukucadang" class="form-control mt-3" id="formGroupExampleInput" placeholder="Suku Cadang" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input type="number" value="{{$data->service_center}}" min="1" max="5" name="servicecenter" class="form-control mt-3" id="formGroupExampleInput" placeholder="Service Center" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <input name="uploadgambar" class="form-control form-control-sm" id="formFileSm" type="file" value="{{$data->tipe_motor}}" accept="image/jpeg" required>
                    </div>
                  </div>
                </div>
